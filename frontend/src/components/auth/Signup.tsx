...
export default function Signup () {
  ...
  return (
    <div
        className="signup-outer-container h-screen flex justify-center items-center"
    >
        <div
                ...
                >
                    ...
                    >
                        <label
                            ...
                            className="signup-email-label flex flex-col font-sans"
                        >
                            Email
                        </label>
                        <input
                        ...
                        <label
                            htmlFor="signup-pw"
                            className="signup-pw-label flex flex-col font-sans"
                        >
                            Password
                        </label>
                        <input
                        ...
                        <label
                            htmlFor="repeat-pw"
                            className="repeat-pw-label flex flex-col font-sans"
                        >
                            Repeat Password
                        </label>
                        <input
